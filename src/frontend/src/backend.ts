...
export class Backend implements backendInterface {
    ...
    async createDoubt(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createDoubt(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createStudyPost(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getDoubts(): Promise<Array<Doubt>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDoubts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudyPosts(): Promise<Array<StudyPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudyPosts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeStudyPost(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeStudyPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
